...
def display_actor_report(data_plan_prod, data_float, rates, acteur_filter, selected_missions, pv_acteur):
    ...
    st.dataframe(styled_jours, use_container_width=True, hide_index=True, height=df_height(df_display))
    ...
    st.dataframe(styled_ca, use_container_width=True, hide_index=True, height=df_height(df_display_ca))
    # ============================
